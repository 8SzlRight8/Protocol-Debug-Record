...
#define I2C_SCL_PORT        GPIOC			/* GPIO端口 */
#define I2C_SCL_CLK         RCC_AHB1Periph_GPIOC		/* GPIO端口时钟 */
#define I2C_SCL_PIN	        GPIO_Pin_12			/* 连接到SCL时钟线的GPIO */

#define I2C_SDA_PORT        GPIOC			/* GPIO端口 */
#define I2C_SDA_CLK         RCC_AHB1Periph_GPIOC		/* GPIO端口时钟 */
#define I2C_SDA_PIN         GPIO_Pin_10			/* 连接到SCL时钟线的GPIO */
...
typedef struct
{
	...
	//i2c check function (_Address : I2C device address)
	uint8_t(*i2c_checkDevice)(uint8_t _Address);
